...
description: "Discover what the Hugo - WeLoveIt theme is all about and the core-concepts behind it."
images: []
resources:
- name: "featured-image"
...
Discover what the Hugo - **WeLoveIt** theme is all about and the core-concepts behind it.
...
The **WeLoveIt** theme’s repository is: [https://github.com/a-goodarzi/WeLoveIt](https://github.com/a-goodarzi/WeLoveIt).

You can download the [release :(far fa-file-archive): .zip file](https://github.com/a-goodarzi/WeLoveIt/releases) of the theme and extract it in the `themes` directory.
...
The following is a basic configuration for the WeLoveIt theme:
...
In addition to [Hugo global configuration](https://gohugo.io/overview/configuration/) and [menu configuration](#basic-configuration), **WeLoveIt** lets you define the following parameters in your site configuration (here is a `hugo.toml`, whose values are default).
...
# Author config
  ...
  [params.page]
    ...
    [params.page.comment]
      ...
      [params.page.comment.valine]
        ...
        # located in "themes/WeLoveIt/assets/lib/valine/emoji/" directory
  ...
  [params.cdn]
    ...
    # ["jsdelivr.yml"]
    # located in "themes/WeLoveIt/assets/data/cdn/" directory
    # you can store your own data files in the same path under your project:
    # "assets/data/cdn/"
    data = ""
...
The default CDN data file is located in `themes/WeLoveIt/assets/data/cdn/` directory.
...
The default data of all supported social links is located in `themes/WeLoveIt/assets/data/social.yaml`,
...
**WeLoveIt** theme has been built to be as configurable as possible by defining custom `.scss` style files.

The directory including the custom `.scss` style files is `assets/css` relative to **your project root directory**.

In `assets/css/_override.scss`, you can override the variables in `themes/WeLoveIt/assets/css/_variables.scss` to customize the style.
...
**WeLoveIt** theme is fully compatible with Hugo multilingual mode, which provides in-browser language switching.
...
To override these values, create a new file in your local i18n folder `i18n/<languageCode>.toml` and inspire yourself from `themes/WeLoveIt/i18n/en.toml`.

By the way, as these translations could be used by other people, please take the time to propose a translation by [:(fas fa-code-branch): making a PR](https://github.com/a-goodarzi/WeLoveIt/pulls) to the theme!

## 5 Search

{{< version 0.2.0 >}}

Based on [Lunr.js](https://lunrjs.com/) or [algolia](https://www.algolia.com/), searching is supported in **WeLoveIt** theme.
